...
const SUPPLY_POSITIONS = {
  ...
  newtons_cradle: { color: 'text-stone-600', pos: 'top-[18%] right-[14%]' }, // Moved from Left
  desk_lamp:      { color: 'text-emerald-800', pos: 'top-[5%] right-[6%]' },  // Moved from Left
  ...
  potted_plant:   { color: 'text-green-600', pos: 'top-[30%] right-[14%]' }, // Moved from Left
  ...
  photo_frame:    { color: 'text-amber-800', pos: 'top-[48%] right-[8%]' },  // Moved from Left
  snack_bowl:     { color: 'text-amber-700', pos: 'top-[54%] right-[14%]' }, // Moved from Left
  ant_farm:       { color: 'text-amber-900', pos: 'top-[54%] right-[4%]' },
  desk_fan:       { color: 'text-stone-500', pos: 'top-[60%] right-[10%]' }, // Moved from Left
  ...
  tamagotchi:     { color: 'text-pink-500', pos: 'top-[72%] right-[6%]' },   // Moved from Left
  laser_pointer:  { color: 'text-red-600', pos: 'top-[78%] right-[14%]' },
  rock_pet:       { color: 'text-stone-600', pos: 'top-[82%] right-[4%]' },  // Moved from Left

  // === BOTTOM RIGHT (Tools & Clutter) ===
  calendar:       { color: 'text-red-700', pos: 'bottom-[35%] right-[12%]' },// Moved from Left
  ...
  water_bottle:   { color: 'text-blue-500', pos: 'bottom-[8%] right-[12%]' }, // Moved from Left
  scissors:       { color: 'text-blue-500', pos: 'bottom-[8%] right-[4%]' },
  cushion:        { color: 'text-indigo-600', pos: 'bottom-[2%] right-[10%]' },// Moved from Left
